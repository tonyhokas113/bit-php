...
if ($_GET['dir'] == 'addAcc') {
    if ($_POST['vardas'] == '') {
        ...
        header('Location: http://127.0.0.1/bit-php/namu-darbai/objektinis-bankas/?dir=homeNewAcc');
        die;
    }
    ...
    header('Location: http://127.0.0.1/bit-php/namu-darbai/bankas/objektinis-?dir=homeNewAcc');
    die;
}
